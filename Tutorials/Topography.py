...
"""
def load_dhdt(dataset_path,xx,yy,interp_method='linear',k=1,begin_year=2014,month=5,end_year=2016):
...
#     mask = mask | ocean_mask #or anywhere that is floating
# 
...
# 
#     # when outside of mask_mat>0 region, the xx_hard or yy_hard is np.nan;
